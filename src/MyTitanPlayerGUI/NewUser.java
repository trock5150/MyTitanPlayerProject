...
public class NewUser extends javax.swing.JFrame {
    ...
    private void okButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_okButtonActionPerformed
        ...
        if (userIDOK && userEmailOK && passwordOK){
            ...
            String encPwd = crypt(newUserpwd);
            
            Users u = new Users(newUserID, newUserEmail, encPwd);
            
            String SQLStmt = "INSERT into Users (USERID,EMAIL,PASSWORD) Values "+ 
                    "('" + newUserID + "', "+"'"+newUserEmail+"',"+"'"+encPwd+"')";
            executeHQLQuery(SQLStmt, u);
            //executeHQLQuery("Commit");
            dispose();
        }
        
    }//GEN-LAST:event_okButtonActionPerformed
    
    private void executeHQLQuery(String hql, Users user) {
